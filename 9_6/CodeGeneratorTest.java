...
public class CodeGeneratorTest {
  private static Program getexpression(int a,int b) {
    Statement [] s1= {new Return(new Binary(new Number(a),Binop.Minus,new Number(b)))};
    Function main=new Function("main",new String[] {},new Declaration[] {},s1);
  ...
  public void testreturn() {
    testProgram(getexpression(12,6), 6);
  }
