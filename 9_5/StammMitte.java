...
public class StammMitte extends Background{
  public StammMitte(int x, int y) {
    super(x,y,WeihnachtsElfen.BACKGROUND_TRUNK_MIDDLE,0);
  }
  ...
  public boolean moveDown(boolean[][] staticObjects,int [][] landscape){
    if(staticObjects[x][y+1]!=true) {
      if(landscape[x][y]!=0)
        landscape[x][y]=landscape[x][y]-WeihnachtsElfen.BACKGROUND_TRUNK_MIDDLE;
      y++;
