...
public class AstLinks extends Background{
  public AstLinks(int x, int y) {
    super(x,y,WeihnachtsElfen.BACKGROUND_GREEN_LEFT,0);
  }
  ...
  public boolean moveDown(boolean[][] staticObjects,int [][] landscape){
    if(staticObjects[x][y+1]!=true) {
      if(landscape[x][y]!=0)
        landscape[x][y]=landscape[x][y]-WeihnachtsElfen.BACKGROUND_GREEN_LEFT;
      y++;
