...
public class CodeGenerationVisitor extends Visitor {
  ...
  public void visit(ArrayInitializer arrayinitializer) {
    Expression size  = arrayinitializer.getSize();
    size.accept(this);
    add(ALLOCH.encode());
  ...
  public void visit(ArrayAccess arrayaccess) {
    ...
    if(name instanceof Variable) {
      arrayname = ((Variable) name).getName();
    }
    if (!locals.containsKey(arrayname))
      throw new RuntimeException("Unknown variable '" + arrayname + "'");
    int variableLocation = locals.get(arrayname);
    index.accept(this);
    add(LDS.encode(variableLocation));
    add(LDH.encode());
  ...
  public void visit(ArrayAssignment arrayassignment) {
    ...
    Expression index = arrayassignment.getIndex();
    Expression value = arrayassignment.getValue();
    value.accept(this);
    index.accept(this);
    Integer location = locals.get(name);
    if (location == null)
